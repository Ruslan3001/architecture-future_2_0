...
| 3 | **ESB Apache Camel как централизованная шина** | Точка отказа и узкое горло; интеграции ведутся point-to-point, новый сервис подключается долго. | С2, С3 | Медленная интеграция новых бизнес-направлений; зависимость релизов от шины. |
...
| **Should** | 3 (замена ESB на Kafka), 7 (миграция в облако), 2 (вывод PowerBuilder) | Сильно влияют на time-to-market и стоимость владения, но могут идти параллельно итерациями. |
